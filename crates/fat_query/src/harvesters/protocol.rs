...
const REQUIRED: &[&str] = &["gpu_protocol_lifecycle_method", "gpu_ordering_call_present"];
const BOOSTERS: &[&str] = &["gpu_async_callback_present"];
const SUPPRESSORS: &[&str] = &["explicit_state_guard", "single_phase_cleanup"];
