...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Execute an Android native instrumentation lane.")
    ...
    parser.add_argument("--bin" "der-transaction", dest="transaction_code", required=True)
                ...
                json.dumps(
                    {
                        ...
                        "adapter_kind": "android-instrumentation-native",
